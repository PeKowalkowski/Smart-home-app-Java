 ...
 public ResponseEntity<ProblemDetail> handleMethodArgumentNotValid(MethodArgumentNotValidException ex) {
  ...
  public ResponseEntity<ProblemDetail> handleBusinessExceptions(RuntimeException ex) {
    ProblemDetail problemDetail = switch (ex) {
      ...
      case BusinessExceptions.UserLockedOrInactiveException userLockedException -> createProblemDetail(
        HttpStatus.LOCKED,
        "User locked or inactive",
        "AUTH_USER_LOCKED_OR_INACTIVE",
        userLockedException.getMessage()
      );
